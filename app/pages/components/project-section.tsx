    ...
    return (
        <section style={{ marginTop: "30px" }}>
            <div style={{ display: "flex", flexDirection: "row", gap: 10, width: "100%", alignItems: "end" }}>
                ...
                <div style={{  display: "flex", flex: 1, flexDirection: "row", justifyContent: "space-between", alignItems: "end", marginBottom: "23px" }}>
            ...
            <div style={{ borderTop: "1px solid #eee", padding: 12, paddingTop: "30px", marginTop: "-23px", marginLeft: "23px" }}>
                { children }
            </div>
        </section>
    );
