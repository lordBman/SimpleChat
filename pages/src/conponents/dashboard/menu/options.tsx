...
export interface OptionsItemProps{active?: string, isMiddle?: boolean, hide?: boolean, icon: string, label:string, id: string, onClicked?: (id: string) => void }

export const OptionsItem: React.FC<OptionsItemProps> = ({ isMiddle, icon, label = false, hide, id, onClicked, active }) =>{
    ...
    return (
        <div onClick={chosen} className={className} style={{ display: hide ? "none" : "flex" }}>
